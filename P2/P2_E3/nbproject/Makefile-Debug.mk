...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p2_e3.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p2_e3.exe: ${OBJECTFILES}
...
${OBJECTDIR}/p2_e3.o: p2_e3.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/p2_e3.o p2_e3.c
