...
Stack * stack_ini(destroy_element_function_type destroy_element_function, copy_element_function_type copy_element_function, print_element_function_type print_element_function){
    Stack *s;
    s = (Stack *)malloc(sizeof(Stack));
    if(s==NULL) return NULL;
    s->top = 0;
    s->destroy_element_function = destroy_element_function;
    s->copy_element_function = copy_element_function;
    s->print_element_function = print_element_function;
    return s;
}
