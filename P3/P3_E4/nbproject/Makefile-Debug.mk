...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p3_e4_nuevo.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p3_e4_nuevo.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p3_e4_nuevo ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/graph_test.o: graph_test.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/graph_test.o graph_test.c
