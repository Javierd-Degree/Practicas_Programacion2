...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p4_e1.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/p4_e1.exe: ${OBJECTFILES}
...
${OBJECTDIR}/p4_e1.o: p4_e1.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/p4_e1.o p4_e1.c
